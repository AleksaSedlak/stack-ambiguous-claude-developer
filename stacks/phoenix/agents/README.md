...
### otp-reviewer
Reviews GenServer, Supervisor, ETS, and Broadway code for correctness and production safety. Catches blocking `handle_call`, unhandled `handle_info`, supervisor restart storms, missing `terminate/2`, ETS outside the supervision tree, and Broadway blocking I/O.
